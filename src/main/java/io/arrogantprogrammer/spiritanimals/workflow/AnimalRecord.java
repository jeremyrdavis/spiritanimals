 ...
 * ]
 */
public record AnimalRecord(String name, @JsonProperty("taxonomy") TaxonomyRecord taxonomy, List<String> locations, @JsonProperty("characteristics") CharacteristicsRecord characteristics) {
}
